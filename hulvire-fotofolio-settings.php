...
if(!class_exists('WP_Hulvire_Fotofolio_Settings'))
{
	class WP_Hulvire_Fotofolio_Settings
	{
        ...
        public function admin_init()
        {
        	...
        	register_setting('wp_hulvire_fotofolio-group', 'setting_checkbox_navigLABELS');
        	register_setting('wp_hulvire_fotofolio-group', 'setting_checkbox_showFOOTER');
        	...
        	register_setting('wp_hulvire_fotofolio-group', 'setting_checkbox_popiskaIMG');
            ...
            add_settings_field(
                'wp_hulvire_fotofolio-setting_checkbox_navigLABELS', 
                'Zobraz navig labels', 
                array(&$this, 'settings_field_input_checkbox'), 
                'wp_hulvire_fotofolio', 
                'wp_hulvire_fotofolio-section',
                array(
                    'field' => 'setting_checkbox_navigLABELS'
                )
            );
            add_settings_field(
                'wp_hulvire_fotofolio-setting_checkbox_showFOOTER', 
                'Zobraz footer', 
                array(&$this, 'settings_field_input_checkbox'), 
                'wp_hulvire_fotofolio', 
                'wp_hulvire_fotofolio-section',
                array(
                    'field' => 'setting_checkbox_showFOOTER'
                )
            );
            add_settings_field(
            ...
            add_settings_field(
                'wp_hulvire_fotofolio-setting_checkbox_popiskaIMG', 
                'Zobraz popisku obrázku', 
                array(&$this, 'settings_field_input_checkbox'), 
                'wp_hulvire_fotofolio', 
                'wp_hulvire_fotofolio-section',
                array(
                    'field' => 'setting_checkbox_popiskaIMG'
                )
            );
            add_settings_field(
